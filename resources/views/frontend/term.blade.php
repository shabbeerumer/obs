...
<div class="modal fade" id="Register" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <div class="contaner-fluid">
        <img src="../img/fqa2.png" style="height:300px; width: 100%; display: flex; object-fit: cover;">
    ...
    <div class="container">
        <h1 style="text-align: center; font-weight: bolder; margin-top: 80px; margin-bottom: 30px;">Terms and Conditions</h1>
        <h6 class="text-danger pb-5">(1) ACCEPTANCE OF TERMS</h6>
        
        <p style="text-align: center;">We provide product and services to you subject to the notices, terms, and conditions set forth in this agreement. Besides, you will obey the  terms and conditions applicable before you use them. If you do not agree to be bound by this Terms & Condition please do not access, register with or use ebike.pk

            We reserve the right to change, modify, add, or remove portions of these Terms and Conditions at any time without any prior notification. The Changes will be effective when posted on the Site with no other notice provided. Please check these Terms and Conditions regularly for updates. Your continued use of OBS following the posting of changes to Terms and Conditions of use constitutes your acceptance of those changes.
            
            These terms and conditions are governed by and construed in accordance with the laws of The Islamic Republic of Pakistan. You agree, as we do, to submit to the exclusive jurisdiction of the courts in Karachi, Pakistan. 
            
            Before proceeding, please read this agreement because accessing, browsing, or otherwise using the Site indicates your agreement to all the terms and conditions in this agreement.</p>
