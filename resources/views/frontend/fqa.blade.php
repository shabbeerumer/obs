...
<div class="" style="background-color:white;">
  ...
  <div class="container">
    <h1 style="text-align: center; font-weight: bolder; margin-top: 80px; margin-bottom: 30px;">FAQs</h1>

    <p style="text-align: center;">If you have forgotten your password on Online Bike Showroom:
      ...
      aType in your new password (and re-confirm it) and press Submit.

      Your password will be reset and you will be logged into Online Bike Showroom.</p>
    <!--start accordian-->
      ...
      <div class="accordion accordion-flush" id="accordionFlushExample">
        <div class="accordion-item">
          ...
          <div id="flush-collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
            <div class="accordion-body">If your child can walk steadily and has developed some hand-eye coordination,
              they may be ready for a balance bike as early as 18 months old. However,
              a more traditional pedal bike with training wheels may be more appropriate for children aged 4 to 6.
            </div>
          </div>
        </div>
        <div class="accordion-item">
          <h2 class="accordion-header">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
              ...
              What’s the easiest bike to ride?
            </button>
          </h2>
          <div id="flush-collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
            <div class="accordion-body">Cruiser bikes are often considered some of the easiest bikes to ride due to
              their relaxed riding position and low seat height.
              Popular cruiser models include the Harley-Davidson Softail, Honda Shadow, and Yamaha Bolt.</div>
          </div>
        </div>
        <div class="accordion-item">
          <h2 class="accordion-header">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
              data-bs-target="#flush-collapseTwo" aria-expanded="false" aria-controls="flush-collapseTwo">
              The top 5 fastest bikes are:
            </button>
          </h2>
          <div id="flush-collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
            <div class="accordion-body">Kawasaki Ninja H2R: 249 mph (400 km/h)<br>
              Dodge Tomahawk: 350 mph (560 km/h)<br>
              MTT Turbine Superbike Y2K: 227 mph (365 km/h)<br>
              Suzuki Hayabusa: 194 mph (312 km/h)<br>
              Honda CBR1100XX Blackbird: 190 mph (310 km/h)</div>
          </div>
        </div>
        <div class="accordion-item">
          <h2 class="accordion-header">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
              data-bs-target="#flush-collapseTwo" aria-expanded="false" aria-controls="flush-collapseTwo">
              Which bike has most powerful engine?
            </button>
          </h2>
          <div id="flush-collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
            <div class="accordion-body">The most powerful production bike is currently the Kawasaki Ninja H2R, which
              has a 998cc supercharged engine producing 310 horsepower. However, this bike is not street legal.</div>
          </div>
        </div>
        <div class="accordion-item">
          <h2 class="accordion-header">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
              ...
              Can I travel 300 km by bike?


            </button>
          </h2>
          <div id="flush-collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
            <div class="accordion-body">It is possible to travel 300 km by bike, but it depends on the bike and the
              rider’s endurance. It’s important to take breaks, stay hydrated, and ensure that the bike is properly
              maintained before embarking on a long-distance ride.</div>
          </div>
        </div>
      </div>
    </div>
    <!--end-->
    <div class="container">
      <img src="D:\Obs\img\fqa1.jpg" height="60%" width="100%" style="padding-top: 10%;">
    </div>
  </div>
</div>
