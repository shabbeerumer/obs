  ...
  <div class="" style="background-color:white;">
    ...
    <body>
      ...
      <swiper-container class="mySwiper" slides-per-view="3" space-between="30" pagination="true"
        ...
        <swiper-slide><img src="../img/honda/honda3.jpg"></swiper-slide>
        <swiper-slide><img src="../img/honda/honda5.jpg"></swiper-slide>
        <swiper-slide><img src="../img/honda/honda2.jpg"></swiper-slide>
        <swiper-slide><img src="../img/honda/honda4.jpg"></swiper-slide>
      </swiper-container>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 col-md-8">
            <h1 class="text-center text-black fw-bold" style="margin-top: 90px;"><b>Honda , CD70 <a href="honda.html" style="text-decoration: none;"><span style="margin-left: 40px; color: red;
            ...
            <div class="tab-content" id="pills-tabContent">
              <div class="tab-pane fade show active mb-5" id="pills-home" role="tabpanel"
                ...
                It is good to say that this is the new model of the motor bike, Honda CD 70 2025 and it
                is the pioneer of high standard of super economy bikes in Pakistan. The motor bike,
                Honda CD 70 has been the ideal choice since many decades. This motor bike is added with
                service network, hassle free provision of spare parts and warranty claim centers to make
                it the best selling motor bike every year. This motor bike has simple and elegant
                graphics and new Honda CD 70 is looking great with stunning colors like red and black
                colors. This motor bike is added with high pitched engine performance with the ever
                green resale value to make it the first choice of the buyers of Pakistan. This motor
                bike has the extended warranty of 2 years and it will give you contentment as you have
                spent on the worthy motor bike.
                Honda CD 70 has been serving the best and most favorite motor bike for the loyal
          ...
          <div class="col-lg-4 col-md-8">
            <h1 class="text-center text-black fw-bold" style="margin-top: 90px;"><b>PKR1,67500</b></h1>
            <div class="container"
