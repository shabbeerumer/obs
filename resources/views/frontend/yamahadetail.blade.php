      ...
      <div class="modal-dialog">
        ...
        <body>
            ...
            <swiper-container class="mySwiper" slides-per-view="3" space-between="30" pagination="true"
                ...
                <swiper-slide><img src="../img/yamaha/yd1.jpg"></swiper-slide>
                <swiper-slide><img src="../img/yamaha/yd2.jpg"></swiper-slide>
                <swiper-slide><img src="../img/yamaha/yd3.jpg"></swiper-slide>
                <swiper-slide><img src="../img/yamaha/yd4.jpg"></swiper-slide>
            </swiper-container>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-md-8">
                        <h1 class="text-center text-black fw-bold" style="margin-top: 90px;"><b> Yamaha Junoon <a href="yamaha.html" style="text-decoration: none;"><span style="margin-left: 40px; color: red;
            font-size: medium;">Accessories</span></a></b></h1>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3">
                                    <div class="card"
                                        ...
                                        <i class="fa-solid fa-calendar-days"
                                            style="font-size: xx-large; font-weight: 900;"></i>
                        ...
                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist"
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill"
                                    ...
                                    aria-selected="true"><span>Vehicals Overview</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill"
                                    data-bs-target="#pills-profile" type="button" role="tab"
                                    aria-controls="pills-profile" aria-selected="false">Suggestions</button>
                            </li>
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active mb-5" id="pills-home" role="tabpanel"
                                ...
                                Yamaha Junoon YD100 is a kickstart, sophisticated and stylish motorcycle in Pakistan.
                                 YD Junoon gives a smooth and comfortable ride at high speeds. Its engine type is 4-Stroke, 
                                 air-cooled, SOHC which is its positive point because the 4-stroke engine is the guarantee
                                  of better ride and performance without emission of any kind of smoke. 2 stroke version of Yamaha Junoon,
                                   Royal is also available but 4 stroke engine is more popular.
                                 The fuel tank capacity is 11 liters and the fuel reserve capacity is 1.5 liters.
                            </div>
                                            ...
                                            <div class="col-md-8" style="background-color:lightgray">
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-text"><i class="fa-solid fa-person"></i>3 seat
                                                        <span style="margin-left: 40px;"><i
                                                                class="fa-solid fa-calendar-days"></i> 2025 Model</span>
                                                        <span style="margin-left: 40px;"><i
                                                                class="fa-solid fa-motorcycle"></i>Petrol</span>
                                                    </p>
                                                    <p style="margin-left: -200px;"><button
                                                            class="btn btn-danger p-2 mt-2"><b>View Details
                                                                ></b></button></p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card mb-3" style="max-width: 80%; height: 300px;">
                                        <div class="row g-0">
                                            <div class="col-md-4 mt-5">
                                                <img src="../img/yamaha/Yamaha.png" class="img-fluid rounded-start"
                                                    alt="...">
                                            </div>
                                            <div class="col-md-8" style="background-color:lightgray">
                                                <div class="card-body">
                                    ...
                                    <div class="card mb-3" style="max-width: 80%; height: 300px;">
                                        <div class="row g-0">
                                            <div class="col-md-4 mt-4">
                                                <img src="../img/honda/honda3.jpg" class="img-fluid rounded-start"
                                                    alt="...">
                                            </div>
                                            <div class="col-md-8" style="background-color:lightgray">
                                                <div class="card-body">
                    ...
                    <div class="col-lg-4 col-md-8">
                        <h1 class="text-center text-black fw-bold" style="margin-top: 90px;"><b>PKR 2,69000</b></h1>
                        <div class="container"
                        ...
                        <form action="">
                            ...
                            <input class="form-control form-control-lg" type="date" id="requiredtime"
                                name="requiredtime">
