...
<body> --}}
  ...
  <div class="" style="background-color:white;">
    ...
    <div class="contaner-fluid">
      <img src="../img/yamaha/banner.png" style="height:300px; width: 100%; display: flex; object-fit: cover;">
      <div class="container-fluid p-3 " style="background-color:rgb(213, 63, 73); text-align: center;">
        <p style="color:black;"><a href="yamahadetail.html" style="text-decoration:none; color:white;">yamaha</a> / /
          Service</p>
    ...
    <div class="container-fluid">
      <h1 style="text-align: center; font-weight: bold; margin-top: 100px; margin-bottom: 100px;">Yamaha Shop</h1>
      <div class="row">
          ...
          .<div class="container">
            ...
            <div class="row">
              <div class="col-lg-4 mt-5">
                <img src="../img/yamaha/y1.png" class="card-img-top">
              </div>
              <div class="col-lg-8 mt-4">
                <p class="card-title">Front HeadLight /Meter Cover/Backlight Complete set for Yamaha YBR 125 CC
                  2025-2024</p>
                <p style="color: red;">RS 700.00</p>
              </div>
            </div>
          </div>
          <div class="container">
            <div class="row">
              <div class="col-lg-4 mt-5">
                <img src="../img/yamaha/y2.png" class="card-img-top">
              </div>
              <div class="col-lg-8 mt-4">
                <p class="card-title">Security key lock Complete set for Yamaha YBR 125 CC 2025-2024</p>
                <p style="color: red;">RS 400.00</p>
              </div>
            </div>
          </div>
          <div class="container">
            <div class="row">
              <div class="col-lg-4 mt-5">
                <img src="../img/yamaha/y3.png" class="card-img-top">
              </div>
              <div class="col-lg-8 mt-4">
                <p class="card-title">Leather/Brake Shoe 125-Ybr (Scc)</p>
                <p style="color: red;">RS 710.00</p>
              </div>
            </div>
          </div>
        ...
        <div class="col-lg-9">
          <div class="row">
            <div class="col-md-4">
              <div class="card">
                <img src="../img/yamaha/y4.png" class="card-img-top p-5 mt-2">
                <div class="card-body">
                  <p class="card-title">Spark Plug/Plug 125 YBR (Ngk Genuine) Yamaha</p>
            ...
            <div class="col-md-4">
              <div class="card">
                <img src="../img/yamaha/y5.png" class="card-img-top p-5 mt-2">
                <div class="card-body">
                  <p class="card-title">Speedo Meter 125cc YBR (Ngk Genuine) Yamaha</p>
            ...
            <div class="col-md-4">
              <div class="card">
                <img src="../img/yamaha/y6.png" class="card-img-top p-5 mt-1">
                <div class="card-body">
                  <p class="card-title">Front / Back Lights 125cc YBR (Genuine) Yamaha</p>
            ...
            <div class="col-md-4">
              <div class="card">
                <img src="../img/yamaha/y7.png" class="card-img-top p-4">
                <div class="card-body pt-5">
                  <p class="card-title">Leather/Brake Shoe 125-Ybr (Scc)</p>
                  <p style="color: red; margin-right: 70%;">RS 700.00</p>
                  <h4 style="margin-left: 80%; margin-top: 20px;"><i class="fa-solid fa-cart-shopping"></i></h4>
                  <div style="color: grey;font-size: x-small; margin-right: 60%;">
                    <i class="fa-solid fa-star"></i>
                    <i class="fa-solid fa-star"></i>
            ...
            <div class="col-md-4">
              <div class="card">
                <img src="../img/yamaha/7.png" class="card-img-top p-5 ">
                <div class="card-body pt-5">
                  <p class="card-title">ROCKER ARM YBR 125 (Mitsuboshi) Yamaha</p>
                  <p style="color: red; margin-right: 70%;">RS 400.00</p>
                  <h4 style="margin-left: 80%; margin-top: 20px;"><i class="fa-solid fa-cart-shopping"></i></h4>
                  <div style="color: grey;font-size: x-small; margin-right: 60%;">
                    <i class="fa-solid fa-star"></i>
                    <i class="fa-solid fa-star"></i>
            ...
            <div class="col-md-4">
              <div class="card">
                <img src="../img/yamaha/y8.png" class="card-img-top p-5">
                <div class="card-body">
                  <p class="card-title">Engein body KIT For Yamaha YZ250F 2025</p>
                  <p style="color: red; margin-right: 70%;">RS 1500.00</p>
                  <h4 style="margin-left: 80%; margin-top: 20px;"><i class="fa-solid fa-cart-shopping"></i></h4>
                  <div style="color: grey;font-size: x-small; margin-right: 60%;">
                    <i class="fa-solid fa-star"></i>
            ...
            <div class="col-md-4">
              <div class="card">
                <img src="../img/yamaha/y9.png" class="card-img-top p-3">
                <div class="card-body pt-5">
                  <p class="card-title">Filter set 125-Ybr (Scc) Yamaha</p>
            ...
            <div class="col-md-4">
              <div class="card">
                <img src="../img/yamaha/y11.png" class="card-img-top p-2">
                <div class="card-body">
                  <p class="card-title">Jeam Set For Engine Yamaha 125cc  (all over) 2024-2025</p>
                  <p style="color: red; margin-right: 70%;">RS 1200.00</p>
                  <h4 style="margin-left: 80%; margin-top: 20px;"><i class="fa-solid fa-cart-shopping"></i></h4>
                  <div style="color: grey;font-size: x-small; margin-right: 60%;">
                    <i class="fa-solid fa-star"></i>
                    <i class="fa-solid fa-star"></i>
            ...
            <div class="col-md-4">
              <div class="card">
                <img src="../img/yamaha/y10.jpg" class="card-img-top p-2">
                <div class="card-body">
                  <p class="card-title">Chain Sprocket Kit 125 YBR (Genuine)/Grari Set Complete 125 YBR</p>
                  <p style="color: red; margin-right: 70%;">RS 730.00</p>
                  <h4 style="margin-left: 80%; margin-top: 20px;"><i class="fa-solid fa-cart-shopping"></i></h4>
                  <div style="color: grey;font-size: x-small; margin-right: 60%;">
                    <i class="fa-solid fa-star"></i>
                    <i class="fa-solid fa-star"></i>
