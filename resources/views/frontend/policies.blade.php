...
<div class="modal fade" id="Register" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <div class="container">
        <h1 style="text-align: center; font-weight: bolder; margin-top: 80px; margin-bottom: 30px;">Privacy Policy</h1>
        
        <p style="text-align: center; padding-top: 30px;">Privacy Policy explains how we collect our customer data. Omline bike showroom ensure to protect their customer’s personal information.
             We don’t collect any personal information about Online Bike Showroom customers unless they submit it on their own. However, we get our customer name, phone number, and email address.

            Online Bike Showroom use their customer information for sending promotional material through channel partner for trend analysis, pattern detection and site administration. We also use our customer IP to help diagnose problems with our server and to administer our website.</p>
            <img src="../img/a2.webp" width="100%" height="40%">
